    ...
    const sessionConfig = {
      ...
      session: {
        instructions: [
          ...
          '═══════════════════════════════════════════════════',
          '',
          '10. LANGUAGE: Always reply in the same language the user is speaking. If the user speaks Spanish, reply in Spanish.',
          '',
          '11. CONCISE: Keep responses concise and conversational since they will be spoken out loud. Avoid long lists; summarize naturally.',
          '',
          '12. GREETINGS: For greetings, introductions, or questions about what you can do, briefly explain you help explore their uploaded documents and invite them to ask.',
        ].join('\n'),
        voice: 'yy6flpd9dq90',
        turn_detection: {
          type: 'server_vad',
